...
print(delete('127.0.0.1:8080/api/v2/users/')) # некорректный запрос, не хватает аргументов
...
print(post('127.0.0.1:8080/api/v2/users', data={'ывлы': 123})) # некорректный запрос, неверный ключ в теле запроса
